...
def get_action_double_left(x,y):
	tan=(x-44.1)/((y-44.1)/0.35+(800.0*(73/75.0)-y)*(1+(1/0.35)))
...
def get_action_double_right(x,y):
	tan=(755.9-x)/((800.0*(73/75.0)-44.1)/0.35 +800.0*(73/5.0)-y)
	angle=np.rad2deg(np.arctan(tan))
	angle=90-angle
	m=1/tan
	c=y-m*x
...
def agent_1player(state):
		...
		if(red!=[]):
			...
			while(i<len(red) and check==0):
				...
				if(abs(tan_angle)>4.8 and red[i][1]>300):
					...
					#print(np.arctan(1))
					#print(((red[i][1]-20.6-140.0))/(red[i][0]-170.0))
					#print(np.arctan(((red[i][1]-20.6-140.0))/(red[i][0]-170.0)))
				...
				if(abs(tan_angle)>4.8 and red[i][1]>300 and check==0):
					...
					#print(((red[i][1]-20.6-140.0))/(red[i][0]-630.0))

					#print(np.arctan((red[i][1]-20.6-140.0))/(red[i][0]-630.0))
	...
	if(check==0): 
		if(red!=[]):
			i=0
			while(i<len(red) and check==0):
				tan_angle_1=(755.9-red[i][1])/(44.1-red[i][0])
				tan_angle_2=(755.9-red[i][1])/(755.9-red[i][0])

				if(abs(tan_angle_1)<1 and red[i][1]>300 and red[i][0]<400.0):
					print("try red center leftmost")
					dis=np.sqrt(pow((red[i][0]-44.1),2)+pow(755.9-red[i][1],2))
					v_vel=np.sqrt(2*0.95*dis)
					#print("v_vel:")
					#print(v_vel)
					line_angle=(red[i][1]-400.0)/(red[i][0]-400.0)
					phi=abs((tan_angle_1-line_angle)/(1+tan_angle_1*line_angle))
					theta=np.rad2deg(np.arctan(phi*0.35))
					#print("theta:")
					#print(theta)
					...
					dis1=np.sqrt(pow((red[i][0]-170.0),2)+pow(140.0-red[i][1],2))
					u_vel=np.sqrt(u_vel*u_vel+2*0.95*dis1)
					alpha=np.rad2deg(np.arctan((red[i][1]-20.6-400.0)/(red[i][0]-400.0)))
					#print(np.arctan(1))
					#print(((red[i][1]-20.6-140.0))/(red[i][0]-170.0))
					#print(np.arctan(((red[i][1]-20.6-140.0))/(red[i][0]-170.0)))
					force=cut_force(red[i][0],400.0,red[i][1],400.0,alpha,20.6,15.01,phi,v_vel)
					#force=(u_vel-17.15)/(378.5-17.15)
					a=str(0.5)+','+str(180.0+alpha)+','+str(force)
					check=1

				
				if(abs(tan_angle_2)<1 and red[i][1]>300 and red[i][0]>400.0 and check==0):
					print("try red center rightmost")
					dis=np.sqrt(pow((red[i][0]-755.9),2)+pow(755.9-red[i][1],2))
					v_vel=np.sqrt(2*0.95*dis)
					#print("v_vel:")
					#print(v_vel)
					line_angle=(red[i][1]-400.0)/(red[i][0]-400.0)
					phi=abs((tan_angle_2-line_angle)/(1+tan_angle_2*line_angle))
					theta=np.rad2deg(np.arctan(phi*0.35))
					angle=np.rad2deg(np.arctan(line_angle))-theta
					phi=np.rad2deg(np.arctan(phi))
					u_vel=np.sqrt(pow(v_vel*np.cos(np.rad2deg(phi))/0.35,2)+pow(v_vel*np.sin(np.rad2deg(phi)),2))/2.8
					...
					#print(np.arctan((red[i][1]-20.6-140.0))/(red[i][0]-630.0))
					force=cut_force2(red[i][0],400.0,red[i][1],400.0,alpha,20.6,15.01,phi,v_vel)

					#force=(u_vel-17.15)/(378.5-17.15)
					a=str(0.5)+','+str(alpha)+','+str(force)
					check=1
				i=i+1      
		if(white!=[]):
			i=0
			while(i<len(white) and check==0):
				tan_angle_1=(755.9-white[i][1])/(44.1-white[i][0])
				tan_angle_2=(755.9-white[i][1])/(755.9-white[i][0])

				if(abs(tan_angle_1)<1 and white[i][1]>300 and white[i][0]<400.0):
					print("try white center leftmost")
					dis=np.sqrt(pow((white[i][0]-44.1),2)+pow(755.9-white[i][1],2))
					v_vel=np.sqrt(2*0.95*dis)
					#print("v_vel:")
					#print(v_vel)
					line_angle=(white[i][1]-400.0)/(white[i][0]-400.0)
					phi=abs((tan_angle_1-line_angle)/(1+tan_angle_1*line_angle))
					theta=np.rad2deg(np.arctan(phi*0.35))
					#print("theta:")
					#print(theta)
					...
					dis1=np.sqrt(pow((white[i][0]-170.0),2)+pow(140.0-white[i][1],2))
					u_vel=np.sqrt(u_vel*u_vel+2*0.95*dis1)
					alpha=np.rad2deg(np.arctan((white[i][1]-20.6-400.0)/(white[i][0]-400.0)))
					#print(np.arctan(1))
					#print(((white[i][1]-20.6-140.0))/(white[i][0]-170.0))
					#print(np.arctan(((white[i][1]-20.6-140.0))/(white[i][0]-170.0)))
					force=cut_force(white[i][0],400.0,white[i][1],400.0,alpha,20.6,15.01,phi,v_vel)
					#force=(u_vel-17.15)/(378.5-17.15)
					a=str(0.5)+','+str(180.0+alpha)+','+str(force)
					check=1

				
				if(abs(tan_angle_2)<1 and white[i][1]>300 and white[i][0]>400.0 and check==0):
					print("try white center rightmost")
					dis=np.sqrt(pow((white[i][0]-755.9),2)+pow(755.9-white[i][1],2))
					v_vel=np.sqrt(2*0.95*dis)
					#print("v_vel:")
					#print(v_vel)
					...
					#print(np.arctan((white[i][1]-20.6-140.0))/(white[i][0]-630.0))
					force=cut_force2(white[i][0],400.0,white[i][1],400.0,alpha,20.6,15.01,phi,v_vel)
		...
		if(black!=[]):
			i=0
			while(i<len(black) and check==0):
				tan_angle_1=(755.9-black[i][1])/(44.1-black[i][0])
				tan_angle_2=(755.9-black[i][1])/(755.9-black[i][0])

				if(abs(tan_angle_1)<1 and black[i][1]>300 and black[i][0]<400.0):
					print("try black center leftmost")
					dis=np.sqrt(pow((black[i][0]-44.1),2)+pow(755.9-black[i][1],2))
					v_vel=np.sqrt(2*0.95*dis)
					#print("v_vel:")
					#print(v_vel)
					line_angle=(black[i][1]-400.0)/(black[i][0]-400.0)
					phi=abs((tan_angle_1-line_angle)/(1+tan_angle_1*line_angle))
					theta=np.rad2deg(np.arctan(phi*0.35))
					#print("theta:")
					#print(theta)
					...
					dis1=np.sqrt(pow((black[i][0]-170.0),2)+pow(140.0-black[i][1],2))
					u_vel=np.sqrt(u_vel*u_vel+2*0.95*dis1)
					alpha=np.rad2deg(np.arctan((black[i][1]-20.6-400.0)/(black[i][0]-400.0)))
					#print(np.arctan(1))
					#print(((black[i][1]-20.6-140.0))/(black[i][0]-170.0))
					#print(np.arctan(((black[i][1]-20.6-140.0))/(black[i][0]-170.0)))
					force=cut_force(black[i][0],400.0,black[i][1],400.0,alpha,20.6,15.01,phi,v_vel)
					#force=(u_vel-17.15)/(378.5-17.15)
					a=str(0.5)+','+str(180.0+alpha)+','+str(force)
					check=1

				
				if(abs(tan_angle_2)<1 and black[i][1]>300 and black[i][0]>400.0 and check==0):
					print("try black center rightmost")
					dis=np.sqrt(pow((black[i][0]-755.9),2)+pow(755.9-black[i][1],2))
					v_vel=np.sqrt(2*0.95*dis)
					#print("v_vel:")
					#print(v_vel)
					...
					alpha=np.rad2deg(np.arctan((black[i][1]-20.6-400.0)/(black[i][0]-400.0)))
					#print(((black[i][1]-20.6-140.0))/(black[i][0]-630.0))

					#print(np.arctan((black[i][1]-20.6-140.0))/(black[i][0]-630.0))
					force=cut_force2(black[i][0],400.0,black[i][1],400.0,alpha,20.6,15.01,phi,v_vel)
